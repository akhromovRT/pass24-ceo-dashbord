...
const HINTS: Record<string, string> = {
  ...
  stopped: 'Сколько клиентов перестали платить с начала года: последний платёж был ' +
    'более 60 дней назад И подписка не оплачена вперёд (предоплативших на месяцы ' +
    'вперёд не считаем). Плюс клиенты с проставленным статусом «Отток». ' +
    'Рост — повод разобрать причины ухода.',
