...
def _result(payments):
    return BankStatementResult(
        filename="t.xlsx", account_number="40702", period="period", owner="owner", payments=payments
    )
    ...
    def test_buyer_inn_normalized_on_create(self, db_session: Session):
        ...
        result = ParseResult(
            ...
            buyers=[
                ParsedBuyer(
                    name="X",
                    inn="71513837810",  # 11 digits, missing leading 0
