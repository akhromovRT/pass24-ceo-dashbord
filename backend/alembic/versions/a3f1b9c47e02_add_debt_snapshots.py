...
def upgrade() -> None:
    ...
    op.create_index(
        ...
        'debt_snapshots', ['import_run_id'], unique=True,
    )
    ...
    op.create_index(
        ...
        'debt_snapshot_rows', ['snapshot_id'], unique=False,
    )
    op.create_index(
        op.f('ix_debt_snapshot_rows_parent_row_id'),
        'debt_snapshot_rows', ['parent_row_id'], unique=False,
    )
    op.create_index(
        op.f('ix_debt_snapshot_rows_organization_id'),
        'debt_snapshot_rows', ['organization_id'], unique=False,
    )
